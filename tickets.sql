...
prompt Created by yanbo on 2019年6月24日
set feedback off
set define off

prompt Creating TICKETS_TAB_CERTTYPE...
create table TICKETS_TAB_CERTTYPE
(
...
comment on column TICKETS_TAB_CERTTYPE.id
  is 'ID';
comment on column TICKETS_TAB_CERTTYPE.content
  is '证件类型';
alter table TICKETS_TAB_CERTTYPE
...
prompt Creating TICKETS_TAB_CITY...
create table TICKETS_TAB_CITY
(
  id     NUMBER(11) not null,
  cityid VARCHAR2(6) not null,
  city   VARCHAR2(50) not null,
  father VARCHAR2(6) not null
)
tablespace USERS
  pctfree 10
  initrans 1
...
comment on column TICKETS_TAB_CITY.id
  is 'ID';
comment on column TICKETS_TAB_CITY.cityid
  is '市标志';
comment on column TICKETS_TAB_CITY.city
  is '市名称';
comment on column TICKETS_TAB_CITY.father
  is '省份标识';
alter table TICKETS_TAB_CITY
...
prompt Creating TICKETS_TAB_PROVINCE...
create table TICKETS_TAB_PROVINCE
(
  id         NUMBER(11) not null,
  provinceid VARCHAR2(6) not null,
...
comment on column TICKETS_TAB_PROVINCE.id
  is 'ID';
comment on column TICKETS_TAB_PROVINCE.provinceid
  is '省份标识';
comment on column TICKETS_TAB_PROVINCE.province
  is '省份名称';
alter table TICKETS_TAB_PROVINCE
...
prompt Creating TICKETS_TAB_USERTYPE...
create table TICKETS_TAB_USERTYPE
(
  id      NUMBER(11) not null,
...
comment on column TICKETS_TAB_USERTYPE.id
  is 'ID';
comment on column TICKETS_TAB_USERTYPE.content
  is '旅客类型';
alter table TICKETS_TAB_USERTYPE
...
prompt Creating TICKETS_TAB_USER...
create table TICKETS_TAB_USER
(
  id         NUMBER(11) not null,
...
comment on column TICKETS_TAB_USER.id
  is 'ID';
comment on column TICKETS_TAB_USER.username
  is '用户名';
comment on column TICKETS_TAB_USER.password
  is '密码';
comment on column TICKETS_TAB_USER.rule
  is '权限(1、管理员 2、普通用户)';
comment on column TICKETS_TAB_USER.realname
  is '真实姓名';
comment on column TICKETS_TAB_USER.sex
  is '性别(1、男 2、女)';
comment on column TICKETS_TAB_USER.city
  is '市信息字典ID值';
comment on column TICKETS_TAB_USER.cert_type
  is '证件类型字典ID值';
comment on column TICKETS_TAB_USER.cert
  is '证件号码';
comment on column TICKETS_TAB_USER.birthday
  is '生日';
comment on column TICKETS_TAB_USER.user_type
  is '旅客类型字典ID值';
comment on column TICKETS_TAB_USER.content
  is '备注信息';
comment on column TICKETS_TAB_USER.status
  is '用户状态（0、无效  1、有效 ）';
comment on column TICKETS_TAB_USER.login_ip
  is '登陆IP';
comment on column TICKETS_TAB_USER.image_path
  is '用户头像路径';
alter table TICKETS_TAB_USER
...
alter table TICKETS_TAB_USER
  ...
  references TICKETS_TAB_CERTTYPE (ID);
alter table TICKETS_TAB_USER
  add constraint TAB_USER_CITY_FK foreign key (CITY)
  references TICKETS_TAB_CITY (ID);
alter table TICKETS_TAB_USER
  add constraint TAB_USER_USERTYPE_FK foreign key (USER_TYPE)
  references TICKETS_TAB_USERTYPE (ID);

prompt Disabling triggers for TICKETS_TAB_CERTTYPE...
alter table TICKETS_TAB_CERTTYPE disable all triggers;
prompt Disabling triggers for TICKETS_TAB_CITY...
alter table TICKETS_TAB_CITY disable all triggers;
prompt Disabling triggers for TICKETS_TAB_PROVINCE...
alter table TICKETS_TAB_PROVINCE disable all triggers;
prompt Disabling triggers for TICKETS_TAB_USERTYPE...
alter table TICKETS_TAB_USERTYPE disable all triggers;
prompt Disabling triggers for TICKETS_TAB_USER...
alter table TICKETS_TAB_USER disable all triggers;
prompt Disabling foreign key constraints for TICKETS_TAB_USER...
alter table TICKETS_TAB_USER disable constraint TAB_USER_CERTTYPE_FK;
alter table TICKETS_TAB_USER disable constraint TAB_USER_CITY_FK;
alter table TICKETS_TAB_USER disable constraint TAB_USER_USERTYPE_FK;
prompt Deleting TICKETS_TAB_USER...
delete from TICKETS_TAB_USER;
commit;
prompt Deleting TICKETS_TAB_USERTYPE...
delete from TICKETS_TAB_USERTYPE;
commit;
prompt Deleting TICKETS_TAB_PROVINCE...
delete from TICKETS_TAB_PROVINCE;
commit;
prompt Deleting TICKETS_TAB_CITY...
delete from TICKETS_TAB_CITY;
commit;
prompt Deleting TICKETS_TAB_CERTTYPE...
delete from TICKETS_TAB_CERTTYPE;
commit;
prompt Loading TICKETS_TAB_CERTTYPE...
insert into TICKETS_TAB_CERTTYPE (id, content)
values (1, '二代身份证');
insert into TICKETS_TAB_CERTTYPE (id, content)
values (2, '港澳通行证');
insert into TICKETS_TAB_CERTTYPE (id, content)
...
prompt Loading TICKETS_TAB_CITY...
insert into TICKETS_TAB_CITY (id, cityid, city, father)
...
prompt Loading TICKETS_TAB_PROVINCE...
insert into TICKETS_TAB_PROVINCE (id, provinceid, province)
values (1, '110000', '北京');
insert into TICKETS_TAB_PROVINCE (id, provinceid, province)
values (2, '120000', '天津');
insert into TICKETS_TAB_PROVINCE (id, provinceid, province)
...
prompt Loading TICKETS_TAB_USERTYPE...
insert into TICKETS_TAB_USERTYPE (id, content)
values (1, '成人');
insert into TICKETS_TAB_USERTYPE (id, content)
values (2, '儿童');
insert into TICKETS_TAB_USERTYPE (id, content)
...
commit;
prompt 4 records loaded
prompt Loading TICKETS_TAB_USER...
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (61, 'testuser3', 'e10adc3949ba59abbe56e057f20f883e', '2', 'testuser2', '1', 5, 1, '44444444444', to_date('05-06-2019', 'dd-mm-yyyy'), 1, 'ee', '1', '0:0:0:0:0:0:0:1', null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (5, 'liguokun', 'e10adc3949ba59abbe56e057f20f883e', '1', '李国琨', '2', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (6, 'hongkong', 'e10adc3949ba59abbe56e057f20f883e', '2', '香港', '1', 200, 2, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 2, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (7, 'taiwan', 'e10adc3949ba59abbe56e057f20f883e', '1', '台湾', '2', 200, 3, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 3, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (8, 'liguowei', 'e10adc3949ba59abbe56e057f20f883e', '2', '李国威', '1', 200, 4, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 4, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (9, 'sunyanchun', 'e10adc3949ba59abbe56e057f20f883e', '1', '孙燕春', '2', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (10, 'xtaiqpl', 'e10adc3949ba59abbe56e057f20f883e', '2', '张辉', '1', 200, 2, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (11, 'aigywf', 'e10adc3949ba59abbe56e057f20f883e', '1', '范玉伟', '2', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (1, 'lkq', 'e10adc3949ba59abbe56e057f20f883e', '1', '李凯晴', '2', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (12, 'cmy', 'e10adc3949ba59abbe56e057f20f883e', '2', '崔明勇', '1', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (13, 'lyq', 'e10adc3949ba59abbe56e057f20f883e', '1', '李毅强', '2', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (14, 'thg', 'e10adc3949ba59abbe56e057f20f883e', '2', '谭浩根', '1', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (15, 'zlr', 'e10adc3949ba59abbe56e057f20f883e', '1', '赵来荣', '2', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (16, 'wrr', 'e10adc3949ba59abbe56e057f20f883e', '2', '吴荣荣', '1', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (17, 'ljh', 'e10adc3949ba59abbe56e057f20f883e', '1', '黎家辉', '2', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (18, 'xwj', 'e10adc3949ba59abbe56e057f20f883e', '2', '幸文杰', '1', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (19, 'cxl', 'e10adc3949ba59abbe56e057f20f883e', '1', '陈炫林', '2', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (20, 'hcj', 'e10adc3949ba59abbe56e057f20f883e', '2', '何丞杰', '1', 200, 1, '440104201910106119', to_date('10-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (21, 'aaa', 'e10adc3949ba59abbe56e057f20f883e', '1', 'aaa', '2', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (22, 'bbb', 'e10adc3949ba59abbe56e057f20f883e', '2', 'bbb', '1', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (23, 'ccc', 'e10adc3949ba59abbe56e057f20f883e', '1', 'ccc', '2', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (24, 'ddd', 'e10adc3949ba59abbe56e057f20f883e', '2', 'ddd', '1', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (25, 'eee', 'e10adc3949ba59abbe56e057f20f883e', '1', 'eee', '2', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (26, 'fff', 'e10adc3949ba59abbe56e057f20f883e', '2', 'fff', '1', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (27, 'ggg', 'e10adc3949ba59abbe56e057f20f883e', '1', 'ggg', '2', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (28, 'hhh', 'e10adc3949ba59abbe56e057f20f883e', '2', 'hhh', '1', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (29, 'iii', 'e10adc3949ba59abbe56e057f20f883e', '1', 'iii', '2', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (30, 'jjj', 'e10adc3949ba59abbe56e057f20f883e', '2', 'jjj', '1', 200, 1, '440104201910106119', to_date('11-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (43, 'testuser1', 'e10adc3949ba59abbe56e057f20f883e', '2', '张三', '1', 200, 1, '440104201910106119', to_date('05-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', '0:0:0:0:0:0:0:1', null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (44, 'testuser2', 'e10adc3949ba59abbe56e057f20f883e', '2', '张三', '1', 200, 1, '440104201910106119', to_date('03-06-2019', 'dd-mm-yyyy'), 1, '备注', '1', '0:0:0:0:0:0:0:1', null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (2, 'sbmnmjge', 'e10adc3949ba59abbe56e057f20f883e', '2', '张三', '1', 203, 1, '440104201910106119', to_date('23-08-2019', 'dd-mm-yyyy'), 1, '备注', '1', '0:0:0:0:0:0:0:1', '11.jpg');
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (3, 'liaolaoshi', 'e10adc3949ba59abbe56e057f20f883e', '1', '张三', '2', 200, 1, '440104201910106119', to_date('09-09-2019', 'dd-mm-yyyy'), 1, '备注', '1', '0:0:0:0:0:0:0:1', null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (4, 'hongge', 'e10adc3949ba59abbe56e057f20f883e', '2', '张三', '1', 200, 1, '440104201910106119', to_date('09-09-2018', 'dd-mm-yyyy'), 1, '备注', '1', '0:0:0:0:0:0:0:1', null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (31, 'user1', 'e10adc3949ba59abbe56e057f20f883e', '1', 'user1', '2', 200, 1, '440104201910106119', to_date('20-12-2007 18:31:34', 'dd-mm-yyyy hh24:mi:ss'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (32, 'user2', 'e10adc3949ba59abbe56e057f20f883e', '1', 'user2', '1', 200, 2, '440104201910106119', to_date('20-12-2007 18:31:34', 'dd-mm-yyyy hh24:mi:ss'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (33, 'user3', 'e10adc3949ba59abbe56e057f20f883e', '2', 'user3', '2', 200, 1, '440104201910106119', to_date('20-12-2007 18:31:34', 'dd-mm-yyyy hh24:mi:ss'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (34, 'user4', 'e10adc3949ba59abbe56e057f20f883e', '1', 'user4', '1', 200, 2, '440104201910106119', to_date('20-12-2007 18:31:34', 'dd-mm-yyyy hh24:mi:ss'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (35, 'user5', 'e10adc3949ba59abbe56e057f20f883e', '2', 'user5', '2', 200, 1, '440104201910106119', to_date('20-12-2007 18:31:34', 'dd-mm-yyyy hh24:mi:ss'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (36, 'user6', 'e10adc3949ba59abbe56e057f20f883e', '1', 'user6', '1', 200, 2, '440104201910106119', to_date('20-12-2007 18:31:34', 'dd-mm-yyyy hh24:mi:ss'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (37, 'user7', 'e10adc3949ba59abbe56e057f20f883e', '2', 'user7', '2', 200, 1, '440104201910106119', to_date('20-12-2007 18:31:34', 'dd-mm-yyyy hh24:mi:ss'), 1, '备注', '1', null, null);
insert into TICKETS_TAB_USER (id, username, password, rule, realname, sex, city, cert_type, cert, birthday, user_type, content, status, login_ip, image_path)
values (38, 'user8', 'e10adc3949ba59abbe56e057f20f883e', '1', 'user8', '1', 200, 2, '440104201910106119', to_date('20-12-2007 18:31:34', 'dd-mm-yyyy hh24:mi:ss'), 1, '备注', '1', null, null);
commit;
prompt 41 records loaded
prompt Enabling foreign key constraints for TICKETS_TAB_USER...
alter table TICKETS_TAB_USER enable constraint TAB_USER_CERTTYPE_FK;
alter table TICKETS_TAB_USER enable constraint TAB_USER_CITY_FK;
alter table TICKETS_TAB_USER enable constraint TAB_USER_USERTYPE_FK;
prompt Enabling triggers for TICKETS_TAB_CERTTYPE...
alter table TICKETS_TAB_CERTTYPE enable all triggers;
prompt Enabling triggers for TICKETS_TAB_CITY...
alter table TICKETS_TAB_CITY enable all triggers;
prompt Enabling triggers for TICKETS_TAB_PROVINCE...
alter table TICKETS_TAB_PROVINCE enable all triggers;
prompt Enabling triggers for TICKETS_TAB_USERTYPE...
alter table TICKETS_TAB_USERTYPE enable all triggers;
prompt Enabling triggers for TICKETS_TAB_USER...
alter table TICKETS_TAB_USER enable all triggers;
