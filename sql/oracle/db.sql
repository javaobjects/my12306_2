...
set feedback off
set define off
prompt Creating TICKETS_CERTTYPE...

create table TICKETS_CERTTYPE
(
...
comment on column TICKETS_CERTTYPE.id
  is 'ID';
comment on column TICKETS_CERTTYPE.content
  is '证件类型';
alter table TICKETS_CERTTYPE
  add constraint TICKETS_CERTTYPE_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
prompt Creating TICKETS_CITY...
create table TICKETS_CITY
(
  id     NUMBER(11) not null,
  cityid VARCHAR2(6),
  city   VARCHAR2(50),
...
comment on column TICKETS_CITY.id
  is 'ID';
comment on column TICKETS_CITY.cityid
  is '市标志';
comment on column TICKETS_CITY.city
  is '市名称';
comment on column TICKETS_CITY.father
  is '省份标识';
alter table TICKETS_CITY
  add constraint TICKETS_CITY_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
prompt Creating TICKETS_PROVINCE...
create table TICKETS_PROVINCE
(
  id         NUMBER(11) not null,
...
comment on column TICKETS_PROVINCE.id
  is 'ID';
comment on column TICKETS_PROVINCE.provinceid
  is '省份标识';
comment on column TICKETS_PROVINCE.province
  is '省份名称';
alter table TICKETS_PROVINCE
  add constraint TICKETS_PROVINCE_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
prompt Creating TICKETS_USERTYPE...
create table TICKETS_USERTYPE
(
  id      NUMBER(11) not null,
...
comment on column TICKETS_USERTYPE.id
  is 'ID';
comment on column TICKETS_USERTYPE.content
  is '旅客类型';
alter table TICKETS_USERTYPE
  add constraint TICKETS_USERTYPE_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
comment on column TICKETS_USER.id
  is 'ID';
comment on column TICKETS_USER.username
  is '用户名';
comment on column TICKETS_USER.password
  is '密码';
comment on column TICKETS_USER.rule
  is '权限(1、管理员 2、普通用户)';
comment on column TICKETS_USER.realname
  is '真实姓名';
comment on column TICKETS_USER.sex
  is '性别(1、男 2、女)';
comment on column TICKETS_USER.city
  is '市信息字典ID值';
comment on column TICKETS_USER.cert_type
  is '证件类型字典ID值';
comment on column TICKETS_USER.cert
  is '证件号码';
comment on column TICKETS_USER.birthday
  is '生日';
comment on column TICKETS_USER.user_type
  is '旅客类型字典ID值';
comment on column TICKETS_USER.content
  is '备注信息';
comment on column TICKETS_USER.status
  is '用户状态（0、无效  1、有效 ）';
comment on column TICKETS_USER.login_ip
  is '登陆IP';
comment on column TICKETS_USER.image_path
  is '用户头像路径';
alter table TICKETS_USER
  add constraint TICKETS_USER_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
alter table TICKETS_USER
  add constraint TICKETS_USER_UK unique (USERNAME)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
alter table TICKETS_USER
  add constraint TICKETS_USER_CERTTYPE_FK foreign key (CERT_TYPE)
  references TICKETS_CERTTYPE (ID);
alter table TICKETS_USER
  add constraint TICKETS_USER_CITY_FK foreign key (CITY)
  references TICKETS_CITY (ID);
alter table TICKETS_USER
  add constraint TICKETS_USER_USERTYPE_FK foreign key (USER_TYPE)
  references TICKETS_USERTYPE (ID);

prompt Disabling triggers for TICKETS_CERTTYPE...
alter table TICKETS_CERTTYPE disable all triggers;
prompt Disabling triggers for TICKETS_CITY...
alter table TICKETS_CITY disable all triggers;
prompt Disabling triggers for TICKETS_PROVINCE...
alter table TICKETS_PROVINCE disable all triggers;
prompt Disabling triggers for TICKETS_USERTYPE...
alter table TICKETS_USERTYPE disable all triggers;
prompt Disabling triggers for TICKETS_USER...
alter table TICKETS_USER disable all triggers;
prompt Disabling foreign key constraints for TICKETS_USER...
alter table TICKETS_USER disable constraint TICKETS_USER_CERTTYPE_FK;
alter table TICKETS_USER disable constraint TICKETS_USER_CITY_FK;
alter table TICKETS_USER disable constraint TICKETS_USER_USERTYPE_FK;
prompt Loading TICKETS_CERTTYPE...
insert into TICKETS_CERTTYPE (id, content)
values (1, '二代身份证');
insert into TICKETS_CERTTYPE (id, content)
values (2, '港澳通行证');
insert into TICKETS_CERTTYPE (id, content)
...
prompt Loading TICKETS_CITY...
insert into TICKETS_CITY (id, cityid, city, father)
...
prompt Loading TICKETS_PROVINCE...
insert into TICKETS_PROVINCE (id, provinceid, province)
values (1, '110000', '北京');
insert into TICKETS_PROVINCE (id, provinceid, province)
values (2, '120000', '天津');
insert into TICKETS_PROVINCE (id, provinceid, province)
...
prompt Loading TICKETS_USERTYPE...
insert into TICKETS_USERTYPE (id, content)
values (1, '成人');
insert into TICKETS_USERTYPE (id, content)
values (2, '儿童');
insert into TICKETS_USERTYPE (id, content)
...
commit;
prompt 4 records loaded
prompt Enabling foreign key constraints for TICKETS_USER...
alter table TICKETS_USER enable constraint TICKETS_USER_CERTTYPE_FK;
alter table TICKETS_USER enable constraint TICKETS_USER_CITY_FK;
alter table TICKETS_USER enable constraint TICKETS_USER_USERTYPE_FK;
prompt Enabling triggers for TICKETS_CERTTYPE...
alter table TICKETS_CERTTYPE enable all triggers;
prompt Enabling triggers for TICKETS_CITY...
alter table TICKETS_CITY enable all triggers;
prompt Enabling triggers for TICKETS_PROVINCE...
alter table TICKETS_PROVINCE enable all triggers;
prompt Enabling triggers for TICKETS_USERTYPE...
alter table TICKETS_USERTYPE enable all triggers;
prompt Enabling triggers for TICKETS_USER...
alter table TICKETS_USER enable all triggers;
set feedback on
set define on
prompt Done.
