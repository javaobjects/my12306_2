...
set feedback off
set define off
prompt Creatingtickets6_2_CERTTYPE...

create tabletickets6_2_CERTTYPE
(
...
comment on columntickets6_2_CERTTYPE.id
  is 'ID';
comment on columntickets6_2_CERTTYPE.content
  is '证件类型';
alter tabletickets6_2_CERTTYPE
  add constrainttickets6_2_CERTTYPE_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
prompt Creatingtickets6_2_CITY...
create tabletickets6_2_CITY
(
  id     NUMBER(11) not null,
  cityid VARCHAR2(6),
  city   VARCHAR2(50),
...
comment on columntickets6_2_CITY.id
  is 'ID';
comment on columntickets6_2_CITY.cityid
  is '市标志';
comment on columntickets6_2_CITY.city
  is '市名称';
comment on columntickets6_2_CITY.father
  is '省份标识';
alter tabletickets6_2_CITY
  add constrainttickets6_2_CITY_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
prompt Creatingtickets6_2_PROVINCE...
create tabletickets6_2_PROVINCE
(
  id         NUMBER(11) not null,
...
comment on columntickets6_2_PROVINCE.id
  is 'ID';
comment on columntickets6_2_PROVINCE.provinceid
  is '省份标识';
comment on columntickets6_2_PROVINCE.province
  is '省份名称';
alter tabletickets6_2_PROVINCE
  add constrainttickets6_2_PROVINCE_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
prompt Creatingtickets6_2_USERTYPE...
create tabletickets6_2_USERTYPE
(
  id      NUMBER(11) not null,
...
comment on columntickets6_2_USERTYPE.id
  is 'ID';
comment on columntickets6_2_USERTYPE.content
  is '旅客类型';
alter tabletickets6_2_USERTYPE
  add constrainttickets6_2_USERTYPE_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
prompt Creatingtickets6_2_USER...
create tabletickets6_2_USER
(
  id         NUMBER(11) not null,
...
comment on columntickets6_2_USER.id
  is 'ID';
comment on columntickets6_2_USER.username
  is '用户名';
comment on columntickets6_2_USER.password
  is '密码';
comment on columntickets6_2_USER.rule
  is '权限(1、管理员 2、普通用户)';
comment on columntickets6_2_USER.realname
  is '真实姓名';
comment on columntickets6_2_USER.sex
  is '性别(1、男 2、女)';
comment on columntickets6_2_USER.city
  is '市信息字典ID值';
comment on columntickets6_2_USER.cert_type
  is '证件类型字典ID值';
comment on columntickets6_2_USER.cert
  is '证件号码';
comment on columntickets6_2_USER.birthday
  is '生日';
comment on columntickets6_2_USER.user_type
  is '旅客类型字典ID值';
comment on columntickets6_2_USER.content
  is '备注信息';
comment on columntickets6_2_USER.status
  is '用户状态（0、无效  1、有效 ）';
comment on columntickets6_2_USER.login_ip
  is '登陆IP';
comment on columntickets6_2_USER.image_path
  is '用户头像路径';
alter tabletickets6_2_USER
  add constrainttickets6_2_USER_PK primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
alter tabletickets6_2_USER
  add constrainttickets6_2_USER_UK unique (USERNAME)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
alter tabletickets6_2_USER
  add constrainttickets6_2_USER_CERTTYPE_FK foreign key (CERT_TYPE)
  referencestickets6_2_CERTTYPE (ID);
alter tabletickets6_2_USER
  add constrainttickets6_2_USER_CITY_FK foreign key (CITY)
  referencestickets6_2_CITY (ID);
alter tabletickets6_2_USER
  add constrainttickets6_2_USER_USERTYPE_FK foreign key (USER_TYPE)
  referencestickets6_2_USERTYPE (ID);

prompt Disabling triggers fortickets6_2_CERTTYPE...
alter tabletickets6_2_CERTTYPE disable all triggers;
prompt Disabling triggers fortickets6_2_CITY...
alter tabletickets6_2_CITY disable all triggers;
prompt Disabling triggers fortickets6_2_PROVINCE...
alter tabletickets6_2_PROVINCE disable all triggers;
prompt Disabling triggers fortickets6_2_USERTYPE...
alter tabletickets6_2_USERTYPE disable all triggers;
prompt Disabling triggers fortickets6_2_USER...
alter tabletickets6_2_USER disable all triggers;
prompt Disabling foreign key constraints fortickets6_2_USER...
alter tabletickets6_2_USER disable constrainttickets6_2_USER_CERTTYPE_FK;
alter tabletickets6_2_USER disable constrainttickets6_2_USER_CITY_FK;
alter tabletickets6_2_USER disable constrainttickets6_2_USER_USERTYPE_FK;
prompt Loadingtickets6_2_CERTTYPE...
insert intotickets6_2_CERTTYPE (id, content)
values (1, '二代身份证');
insert intotickets6_2_CERTTYPE (id, content)
values (2, '港澳通行证');
insert intotickets6_2_CERTTYPE (id, content)
...
prompt Loadingtickets6_2_CITY...
insert intotickets6_2_CITY (id, cityid, city, father)
...
prompt Loadingtickets6_2_PROVINCE...
insert intotickets6_2_PROVINCE (id, provinceid, province)
values (1, '110000', '北京');
insert intotickets6_2_PROVINCE (id, provinceid, province)
values (2, '120000', '天津');
insert intotickets6_2_PROVINCE (id, provinceid, province)
...
prompt Loadingtickets6_2_USERTYPE...
insert intotickets6_2_USERTYPE (id, content)
values (1, '成人');
insert intotickets6_2_USERTYPE (id, content)
values (2, '儿童');
insert intotickets6_2_USERTYPE (id, content)
...
commit;
prompt 4 records loaded
prompt Enabling foreign key constraints fortickets6_2_USER...
alter tabletickets6_2_USER enable constrainttickets6_2_USER_CERTTYPE_FK;
alter tabletickets6_2_USER enable constrainttickets6_2_USER_CITY_FK;
alter tabletickets6_2_USER enable constrainttickets6_2_USER_USERTYPE_FK;
prompt Enabling triggers fortickets6_2_CERTTYPE...
alter tabletickets6_2_CERTTYPE enable all triggers;
prompt Enabling triggers fortickets6_2_CITY...
alter tabletickets6_2_CITY enable all triggers;
prompt Enabling triggers fortickets6_2_PROVINCE...
alter tabletickets6_2_PROVINCE enable all triggers;
prompt Enabling triggers fortickets6_2_USERTYPE...
alter tabletickets6_2_USERTYPE enable all triggers;
prompt Enabling triggers fortickets6_2_USER...
alter tabletickets6_2_USER enable all triggers;
set feedback on
set define on
prompt Done.
